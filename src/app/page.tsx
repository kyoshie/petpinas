          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6 text-balance">
                Connecting Stray Pets with{" "}
                <span className="text-primary">Loving Homes</span>
              </h1>
              <p className="text-lg text-foreground/80 mb-8 leading-relaxed text-balance">
                Find, Rescue, Adopt — All in One Place. Discover adoptable cats
                and dogs from trusted local rescue centers. Give them a second
                chance at life — or find your new best friend today.
              </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-card rounded-xl p-8 border border-border hover:border-primary/50 transition-colors">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">
                Verified Rescue Centers
              </h3>
              <p className="text-foreground/70 leading-relaxed">
                Every pet listing comes from trusted, registered rescue
                organizations. We thoroughly vet all rescue centers to ensure
            ...
            <div className="bg-card rounded-xl p-8 border border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-foreground/70 leading-relaxed">
                Apply to adopt with a few clicks. Track your application status
                in real-time and stay connected with the rescue center
            ...
            <div className="bg-card rounded-xl p-8 border border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-foreground/70 leading-relaxed">
                Volunteer or report stray pets — help improve your neighborhood.
                Join a community of pet lovers dedicated to making a difference.
              </p>
            </div>
            ...
            <div className="bg-card rounded-xl p-8 border border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-foreground/70 leading-relaxed">
                Each pet profile includes medical records, vaccinations, and
                rescue story. Make informed decisions with complete pet
                information.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="relative">
              <div className="bg-white rounded-xl p-6 border-2 border-primary/40 text-center">
                ...
                <p className="text-sm text-foreground/70">
                  View adoptable animals with photos and details
                </p>
              </div>
            ...
            <div className="relative">
              <div className="bg-white rounded-xl p-6 border-2 border-accent/40 text-center">
                ...
                <p className="text-sm text-foreground/70">
                  Rescue center contacts you for adoption meet-ups
                </p>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground/70">
              Join thousands of happy adopters and volunteers
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-card rounded-xl p-8 border border-border">
              ...
              <p className="text-foreground/80 mb-6 leading-relaxed">
                "I adopted Max through this platform — couldn't be happier! The
                entire process was smooth and the rescue center was so helpful.
                Max has completely transformed our lives."
              </p>
            ...
            <div className="bg-card rounded-xl p-8 border border-border">
              ...
              <p className="text-foreground/80 mb-6 leading-relaxed">
                "As a volunteer, I can track stray pets and help rescue them
                efficiently. This platform has made it so much easier to
                coordinate rescue efforts and connect with other passionate
      ...
      <section className="py-20 sm:py-32 px-4 sm:px-6 lg:px-8 bg-linear-to-r from-primary/20 to-secondary/20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-foreground/70 mb-8 leading-relaxed text-balance">
            Whether you're looking to adopt, volunteer, or report stray pets,
            your contribution matters. Every action brings us closer to a world
